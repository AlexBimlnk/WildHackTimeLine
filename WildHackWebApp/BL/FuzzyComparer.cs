...
{
    /// <summary>
    /// Выполняет нечеткое сравнение строк. Используется в Judge.
    /// </summary>
    public static class FuzzyComparer
    {
        ...
        /// </summary>
        private static double ThresholdSentence = 0.165;
        ...
        /// к количеству различных.
        /// </summary>
        private static double ThresholdWord = 0.45;
        ...
        /*public FuzzyComparer(double aThresholdSentence = 0.165, double aThresholdWord = 0.45, int aMinWordLength = 3, int aSubtokenLength = 2)
        {
        ...
        public static bool IsFuzzyEqual(string first, string second)
        {
        ...
        private static bool IsTokensFuzzyEqual(string firstToken, string secondToken)
        {
