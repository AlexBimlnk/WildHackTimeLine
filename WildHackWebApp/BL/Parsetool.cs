    ...
    public class ParseTool
    {
        private static Dictionary<SiteName, PageElement> siteDict = new Dictionary<SiteName, PageElement>
        {
            ...
            {SiteName.GoogleNews, new PageElement() {
                                         ...
                                         RequestURL = "https://news.google.com/search?q=%D0%BA%D0%B0%D0%BC%D1%87%D0%B0%D1%82%D0%BA%D0%B0%20%D0%BA%D1%80%D0%BE%D0%BD%D0%BE%D1%86%D0%BA%D0%B8%D0%B9%20%D0%B7%D0%B0%D0%BF%D0%BE%D0%B2%D0%B5%D0%B4%D0%BD%D0%B8%D0%BA%20when%3A24d&hl=ru&gl=RU&ceid=RU%3Aru",
            ...
            {SiteName.Kronoki, new PageElement() {
                                         SiteURL = "https://kronoki.ru",
                                         RequestURL = "https://kronoki.ru/ru/news/newswire/",
                                         ArticlesPath = ".//div[@class='col-md-12 mb-4']",
                                         TitlePath = ".//h2",
                                         TimePath = ".//p[@class='news-date mt-2 mt-sm-0']",
                                         LinkPath = ".//div[@class='h-100']/a[@href]/@href",
                                         PictureURL = ".//img[@class='img-fluid w-100']/@src"} },
        };
